...
// Settings
// static const uint16_t timer_divider = 80; // old version: 1 MHz hardware timer
static const uint32_t timer_freq = 1e6; // 1MHz frequency (1 count = 1μs)
static const uint64_t timer_max_count = 0.1e6;  // 1 second ISR interval
...
void IRAM_ATTR onTimer() {
  ...
  // Interrupt watchdog timer occurs
