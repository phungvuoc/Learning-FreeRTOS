/**
 * FreeRTOS Counting Semaphore Challenge 1 - Using Queue
 *
...
static SemaphoreHandle_t mutex;       // Lock access for critical sections
...
void setup() {
  ...
  msg_queue = xQueueCreate(BUF_SIZE, sizeof(int));
